        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ URL::route('paid')}}">الفواتير المدفوعة</a></li>
                    <li><a class="slide-item" href="{{ URL::route('unPaid')}}">الفواتير الغير مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ URL::route('partial') }}">الفواتير المدفوعة جزئيا</a></li>
                    <li><a class="slide-item" href="{{ URL::route('invoiceArchive.index') }}">ارشيف الفواتير</a></li>
